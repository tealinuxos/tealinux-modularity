...
<Sidebar.Root collapsible="icon">
	<Sidebar.Header class="flex flex-row gap-x-2 items-center px-4 py-3 border-b overflow-hidden">
		<img class="size-8 shrink-0" src="tealinux.svg" alt="TeaLinuxOS Logo" />
		{#if sidebar.state === 'expanded'}
			<p class="text-[#54CD4C] font-bold text-xl truncate">TeaLinuxOS</p>
		{/if}
	</Sidebar.Header>
