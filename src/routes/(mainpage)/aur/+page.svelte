...
<div class="flex flex-col gap-6 p-6 h-full overflow-y-auto">
	...
	<div class="flex items-center justify-between">
		<div class="flex items-center gap-3">
			...
			<div>
				<h1 class="text-xl font-bold text-foreground">AUR Packages</h1>
		...
		{#if installedPackages.length > 0}
			<div class="px-3 py-1.5 rounded-lg bg-accent text-accent-foreground text-xs font-medium">
	...
	{#if activeTab === 'installed'}
		...
		{:else if installedPackages.length === 0}
			<div class="flex flex-col items-center justify-center py-16 gap-3">
				...
				<p class="text-muted-foreground text-sm">Search and install packages from the AUR</p>
			</div>
		{:else}
